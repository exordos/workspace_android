...
| AUTH-003 | Login by nickname | Valid credentials | Tokens stored encrypted; main navigation opens | Android real-client MockEngine token/project flow passed; live backend navigation remains |
...
| AUTH-006 | OTP challenge | Correct six-digit code | One continuation request; authenticated session | Android real-client MockEngine challenge/header/project-token path passed; live backend remains |
